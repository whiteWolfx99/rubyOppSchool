...
class App
  ...
  def select_opt
    ...
    when 7 then exit(true)
      ...
      puts 'Please enter one of these'
    end
  end
  ...
  def create_book
    ...
    puts 'Book Ha Been Created Successfully'
  end
  ...
  def check_number(msg)
    ...
    loop do
      ...
      if input.is_a?(Integer) && input.positive?
        ...
        puts 'Please, enter a valid input please use number'
      end
    end
    number
  end
  ...
  def create_person
    num = check_options('Do you want to create a student [1] or a teacher [2]?', [1, 2])
